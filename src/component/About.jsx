...
const About = () => {
  return (
    <section className=' body-font m-auto max-w-[1268px]'>
      <div className='container px-5 py-24 mx-auto flex flex-wrap'>
        ...
        <div className='flex flex-wrap w-full'>
          <div className='lg:w-2/5 md:w-1/2 md:pr-10 md:py-6 mt-10'>
          ...
          <img
            className='lg:w-3/5 md:w-1/2 object-cover object-right rounded-lg md:mt-0 mt-12'
            src={heroimg}
            alt='step'
          />
        </div>
